<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('psr_kabkot_id')); ?>:</b>
	<?php echo CHtml::link(CHtml::encode($data->psr_kabkot_id),array('view','id'=>$data->psr_kabkot_id)); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('psr_kabkot_name')); ?>:</b>
	<?php echo CHtml::encode($data->psr_kabkot_name); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('psr_prop_id')); ?>:</b>
	<?php echo CHtml::encode($data->psr_prop_id); ?>
	<br />
