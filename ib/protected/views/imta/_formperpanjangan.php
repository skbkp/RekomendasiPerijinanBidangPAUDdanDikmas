...
<fieldset>
	...
	<?php echo $form->datepickerRow($model,'ib_imta_jatuh_tempo',array('prepend'=>'<i class="icon-calendar"></i>','append'=>'<span class="label label-important">yyyy-mm-dd</span>','class'=>'span2','options'=>array('format'=>'yyyy-mm-dd'))); ?>
</fieldset>
