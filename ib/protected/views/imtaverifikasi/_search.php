<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<?php echo $form->textFieldRow($model,'nilai_imta_id',array('class'=>'span5')); ?>

	<?php echo $form->textFieldRow($model,'ib_imta_id',array('class'=>'span5')); ?>
	...
	<?php echo $form->textFieldRow($model,'v_skrptka',array('class'=>'span5')); ?>

	<?php echo $form->textAreaRow($model,'v_reason_skrptka',array('rows'=>6, 'cols'=>50, 'class'=>'span8')); ?>

	<?php echo $form->textFieldRow($model,'v_ijinoperasional',array('class'=>'span5')); ?>

	<?php echo $form->textAreaRow($model,'v_reason_ijinoperasional',array('rows'=>6, 'cols'=>50, 'class'=>'span8')); ?>

	<?php echo $form->textFieldRow($model,'v_rekapsiswadanptk',array('class'=>'span5')); ?>

	<?php echo $form->textAreaRow($model,'v_reason_rekapsiswadanptk',array('rows'=>6, 'cols'=>50, 'class'=>'span8')); ?>

	<?php echo $form->textFieldRow($model,'v_rekomendasidinas',array('class'=>'span5')); ?>

	<?php echo $form->textAreaRow($model,'v_reason_rekomendasidinas',array('rows'=>6, 'cols'=>50, 'class'=>'span8')); ?>
