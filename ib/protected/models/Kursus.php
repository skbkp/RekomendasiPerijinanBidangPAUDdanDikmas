 ...
 * @property string $ib_kursus_jatuh_tempo 
...
public function getib_kursus_sekarang()
{
  return date('Y-m-d',strtotime("+30 days"));
	...
	//		array('ib_kursus_status, ib_kursus_peserta_name','readOnly', 'on'=>'update'),
			...
			array('ib_kursus_id, user_id, ib_kursus_peserta_name, ib_kursus_peserta_jk, ib_kursus_peserta_tmplahir, ib_kursus_peserta_tgllahir,status_perpanjangan, ib_kursus_peserta_negara,ib_kursus_jatuh_tempo,ib_kursus_peserta_pasport, ib_kursus_peserta_pasport_start, ib_kursus_peserta_pasport_exp, ib_kursus_peserta_alamat_ln, ib_kursus_peserta_alamat_id, ib_kursus_peserta_prop_id, ib_kursus_peserta_kabkot_id, ib_kursus_lbg_name, ib_kursus_lbg_alamat, ib_kursus_lbg_prop_id, ib_kursus_lbg_kabkot_id, ib_kursus_lbg_kodepos, ib_kursus_lbg_tlp, ib_kursus_lbg_fax, ib_kursus_lbg_ijin_oleh,ib_kursus_lbg_ijin_oleh_name,ib_kursus_lbg_ijin_no, ib_kursus_lbg_ijin_tgl, ib_kursus_lbg_ijin_start, ib_kursus_lbg_ijin_exp, ib_kursus_peserta_biaya, ib_kursus_peserta_alasan, ib_kursus_peserta_jaminan, ib_kursus_peserta_pendidikan,ib_kursus_peserta_nosurat,ib_kursus_peserta_tglsurat, ib_jeniskursus,ib_kursus_nilek, ib_kursus_create_at, ib_kursus_update_at, ib_kursus_update_by', 'safe', 'on'=>'search'),
           array('ib_kursus_id, user_id, ib_kursus_peserta_name, ib_kursus_peserta_jk, ib_kursus_peserta_tmplahir, ib_kursus_peserta_tgllahir, status_perpanjangan,ib_kursus_peserta_negara,ib_kursus_jatuh_tempo,ib_kursus_peserta_pasport, ib_kursus_peserta_pasport_start, ib_kursus_peserta_pasport_exp, ib_kursus_peserta_alamat_ln, ib_kursus_peserta_alamat_id, ib_kursus_peserta_prop_id, ib_kursus_peserta_kabkot_id, ib_kursus_lbg_name, ib_kursus_lbg_alamat, ib_kursus_lbg_prop_id, ib_kursus_lbg_kabkot_id, ib_kursus_lbg_kodepos, ib_kursus_lbg_tlp, ib_kursus_lbg_fax, ib_kursus_lbg_ijin_oleh,ib_kursus_lbg_ijin_oleh_name,ib_kursus_lbg_ijin_no, ib_kursus_lbg_ijin_tgl, ib_kursus_lbg_ijin_start, ib_kursus_lbg_ijin_exp, ib_kursus_peserta_biaya, ib_kursus_peserta_alasan, ib_kursus_peserta_jaminan, ib_kursus_peserta_pendidikan,ib_kursus_peserta_nosurat,ib_kursus_peserta_tglsurat, ib_jeniskursus,ib_kursus_nilek, ib_kursus_create_at, ib_kursus_update_at, ib_kursus_update_by', 'safe', 'on'=>'update'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'kursusjenispengajuan'=>array(self::BELONGS_TO,'Jenisimta','ib_kursus_jenis_kursus'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'ib_kursus_jatuh_tempo' => 'Tanggal Jatuh Tempo',
			'ib_kursus_jenis_kursus' => 'Jenis Pengajuan',
	...
	public function search()
	{
		...
		$criteria->compare('ib_kursus_nilek',$this->ib_kursus_nilek,true);
		...
		$criteria->compare('ib_kursus_jenis_kursus',$this->ib_kursus_jenis_kursus);
		...
		$criteria->compare('ib_kursus_jatuh_tempo',$this->ib_kursus_jatuh_tempo);
 ...
 public function afterSave() {
    if ($this->ib_kursus_status==67 && $this->status_perpanjangan=='N')
   
   Kursus::model()->updateByPk($this->ib_kursus_id,array('ib_kursus_jatuh_tempo'=>new CDbExpression('NOW() + INTERVAL 1 YEAR')));
