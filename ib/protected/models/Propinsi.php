...
/**
 * This is the model class for table "psr_rpropinsi".
 *
 * The followings are the available columns in table 'psr_rpropinsi':
 * @property integer $psr_prop_id
 * @property string $psr_prop_name
...
class Propinsi extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('psr_prop_name, psr_reg_id, psr_posted_by, psr_lastupdate', 'required'),
			array('psr_reg_id, psr_sync', 'numerical', 'integerOnly'=>true),
			array('psr_prop_name', 'length', 'max'=>50),
			array('psr_posted_by', 'length', 'max'=>30),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('psr_prop_id, psr_prop_name, psr_reg_id, psr_posted_by, psr_lastupdate, psr_sync', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('psr_prop_name',$this->psr_prop_name,true);
