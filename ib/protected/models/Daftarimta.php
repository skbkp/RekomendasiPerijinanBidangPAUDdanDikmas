...
class Daftarimta extends CActiveRecord
{
	/**
  ...
  return date('Y-m-d',strtotime("+30 days"));
	...
	public function relations()
	{
		...
		return array(
            ...
            'imtaverifikasiperpanjangan' => array(self::HAS_ONE, 'Imtaverifikasiperpanjangan', 'ib_imta_id'),
            'imtaperpanjangan'=>array(self::HAS_ONE,'Imtaperpanjangan','imta_id'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'ib_imta_daftar_at' => 'Tanggal Pendaftaran',
