 ...
 * @property string ib_paud_jenis_paud
 * @property integer $ib_paud_status
 * @property string $ib_paud_sekarang
 * @property string $ib_paud_jatuh_tempo
 * @property string $status_perpanjangan
 */
class Paud extends CActiveRecord
{
	/**
...
public function getib_paud_sekarang()
{
  return date('Y-m-d',strtotime("+30 days"));
	...
	public function rules()
	{
		...
		return array(
			array('ib_paud_status,ib_paud_peserta_name, ib_paud_peserta_jk, ib_paud_peserta_tmplahir, ib_paud_peserta_tgllahir, ib_paud_peserta_negara, ib_paud_peserta_surat,ib_paud_peserta_surat_tgl, ib_paud_peserta_ortu_name, ib_paud_ayah_wn, ib_paud_peserta_ortu_name_ibu, ib_paud_ibu_wn, ib_paud_peserta_ortu_job, ib_paud_peserta_kk, ib_paud_peserta_tgjwb, ib_paud_peserta_alamat_id, ib_paud_peserta_prop_id, ib_paud_peserta_kabkot_id, ib_paud_lbg_name, ib_paud_lbg_alamat, ib_paud_lbg_prop_id, ib_paud_lbg_kabkot_id, ib_paud_lbg_kodepos, ib_paud_lbg_tlp, ib_paud_lbg_fax, ib_paud_lbg_ijin_oleh, ib_paud_lbg_ijin_tgl, ib_paud_lbg_ijin_start, ib_paud_lbg_ijin_exp, ib_paud_peserta_jaminan,ib_paud_jenis_paud,ib_paud_jatuh_tempo,ib_paud_nilek,status_perpanjangan', 'required'),
			...
			array('ib_paud_peserta_name, ib_paud_lbg_name,ib_paud_peserta_jaminan,status_perpanjangan', 'length', 'max'=>200),
			array('ib_paud_peserta_tmplahir, ib_paud_ayah_pasport, ib_paud_peserta_surat, ib_paud_peserta_ortu_job, ib_paud_peserta_tgjwb,ib_paud_ayah_pasport, ib_paud_ayah_pasport_start,ib_paud_nilek,ib_paud_ayah_pasport_exp,ib_paud_ayah_ktp, ib_paud_ayah_ktp_start, ib_paud_ayah_ktp_exp,ib_paud_ibu_pasport, ib_paud_ibu_pasport_start, ib_paud_ibu_pasport_exp,ib_paud_ibu_ktp, ib_paud_ibu_ktp_start,ib_paud_ibu_ktp_exp', 'length', 'max'=>50),
			...
			array('ib_paud_id, user_id, ib_paud_peserta_name, ib_paud_peserta_jk, ib_paud_peserta_tmplahir, ib_paud_peserta_tgllahir, ib_paud_peserta_negara, ib_paud_ayah_pasport,ib_paud_jatuh_tempo,ib_paud_ayah_pasport_start, ib_paud_ayah_pasport_exp, ib_paud_peserta_surat,ib_paud_peserta_surat_tgl, ib_paud_peserta_ortu_name, ib_paud_peserta_ortu_job, ib_paud_peserta_kk, ib_paud_peserta_tgjwb, ib_paud_peserta_alamat_id,ib_paud_peserta_alamat_ln, ib_paud_peserta_prop_id, ib_paud_peserta_kabkot_id, ib_paud_lbg_name,ib_paud_nilek,ib_paud_lbg_alamat, ib_paud_lbg_prop_id, ib_paud_lbg_kabkot_id, ib_paud_lbg_kodepos, ib_paud_lbg_tlp, ib_paud_lbg_fax, ib_paud_lbg_ijin_oleh, ib_paud_lbg_ijin_tgl, ib_paud_lbg_ijin_start, ib_paud_lbg_ijin_exp, ib_paud_peserta_jaminan, ib_paud_create_at, ib_paud_update_at, ib_paud_update_by,ib_paud_jenis_paud,status_perpanjangan', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'paudpesertanegara'=>array(self::BELONGS_TO,'Negara','ib_paud_peserta_negara'),
                        ...
                        'paudjenispaud'=>array(self::BELONGS_TO,'Jenisimta','ib_paud_jenis_paud'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'ib_paud_jenis_paud' => 'Jenis Pengajuan',
			'ib_paud_status' => 'Status',
			'ib_paud_jatuh_tempo' => 'Tanggal Jatuh Tempo',
	...
	public function search()
	{
		...
		$criteria->compare('ib_paud_nilek',$this->ib_paud_nilek,true);
		...
		$criteria->compare('ib_paud_jenis_paud',$this->ib_paud_jenis_paud);
		$criteria->compare('ib_paud_status',$this->ib_paud_status);
		$criteria->compare('ib_paud_jatuh_tempo',$this->ib_paud_jatuh_tempo);
    ...
    if ($this->ib_paud_status==67 && $this->status_perpanjangan=='N')
   
   Paud::model()->updateByPk($this->ib_paud_id,array('ib_paud_jatuh_tempo'=>new CDbExpression('NOW() + INTERVAL 1 YEAR')));
