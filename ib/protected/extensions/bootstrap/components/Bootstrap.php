...
class Bootstrap extends CApplicationComponent
{
	...
	public function registerJS($position = CClientScript::POS_HEAD)
	{
		...
		if ($this->enableBootboxJS)
			$cs->registerScriptFile($this->getAssetsUrl() . '/js/bootstrap.bootbox.min.js', CClientScript::POS_END);
		...
		if ($this->enableNotifierJS)
		{
			...
			$cs->registerScriptFile($this->getAssetsUrl() . '/js/bootstrap.notify.js', CClientScript::POS_END);
		}
		$cs->registerScriptFile($this->getAssetsUrl() . '/js/bootstrap' . (!YII_DEBUG ? '.min' : '') . '.js', CClientScript::POS_END);
	}
